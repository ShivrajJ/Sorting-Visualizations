...
async function bubbleSort(arr : Array<number>, setArr : React.Dispatch<React.SetStateAction<number[]>>): Promise<Array<number>> {
...
async function selectionSort(arr : Array<number>, setArr : React.Dispatch<React.SetStateAction<number[]>>): Promise<Array<number>> {
  for(let i : number = 0; i<arr.length-1; i++) {
...
async function insertionSort(arr:Array<number>, setArr: React.Dispatch<React.SetStateAction<number[]>>): Promise<Array<number>> {
...
async function mergeSort(arr : Array<number>, setArr : React.Dispatch<React.SetStateAction<number[]>>): Promise<Array<number>> {
...
async function quickSort(arr : Array<number>, setArr : React.Dispatch<React.SetStateAction<number[]>>): Promise<Array<number>> {
